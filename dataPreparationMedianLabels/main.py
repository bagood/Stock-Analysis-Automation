...
from dataPreparationMedianLabels.helper import _download_stock_data, _generate_all_median_gain
...
def prepare_data_for_modelling(emiten: str, start_date: str, end_date: str, target_column: str, rolling_windows: list, download: bool = True) -> pd.DataFrame:
    ...
    3. Creates the target variable(s) by calculating future median of price gain
